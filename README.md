...
You'll probably have to make an account to use it. Get into GitHub Desktop, then go to File, then go to Clone Repository. Click URL, then enter the following URL: https://github.com/aarish-lakhani/aarishs-forest.git. Make sure to take note of the Local Path below it, that'll be where it exists after. You'll need that for when you open it in Obsidian.

Once you've cloned it, it's on your computer! You can then download Obsidian: https://obsidian.md/download, and open the folder which has the cloned repository in it. Open either the Foraging folder or the Gardening folder (coming soon).
